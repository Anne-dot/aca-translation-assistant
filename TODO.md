...
- **Progress:**
  ...
  - ⏳ **Issue #14:** Design final JSON schema based on all 3 decisions (IN PROGRESS)
    - ✅ 17/18 decisions made (94% complete, documented in Issue #14 comments)
    ...
    - ✅ Decision 17: All _metadata fields complete (4 parts: termComplexity, componentTerms, isGlossaryTerm, termType, addedReason, derivedFrom, componentLookups)
    - ✅ Case-by-case analysis completed: naming conflicts resolved, TBX_vs_MY_PLANS.md corrected to camelCase (47+ fixes)
    - ⏸️ Remaining: Decision 18 (validation & final schema)
